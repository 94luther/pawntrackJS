...
create index if not exists inventory_sales_sold_at_idx on inventory_sales (sold_at desc);
create index if not exists inventory_sales_product_idx on inventory_sales (product);
